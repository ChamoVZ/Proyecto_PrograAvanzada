...
{
    /// <summary>
    /// Lógica de negocio de retos. El controller SOLO habla con esta clase;
    /// nunca con el repositorio ni con el DbContext (Regla de Oro).
    /// Patrón idéntico al ProductBusiness del proyecto de referencia.
    /// </summary>
    public class RetoBusiness
    {
        ...
        /// <summary>Constructor para pruebas: permite inyectar un repositorio falso (mock).</summary>
